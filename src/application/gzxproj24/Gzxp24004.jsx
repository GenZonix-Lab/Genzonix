...
import ConnectDiagram from './assert/proj_4/Connection_diagram.png'
import img1 from './assert/proj_4/1.png'
import img2 from './assert/proj_4/2.png'
import img3 from './assert/proj_4/3.png'
import img4 from './assert/proj_4/4.png'
import img5 from './assert/proj_4/5.png'
import img6 from './assert/proj_4/6.png'
import img7 from './assert/proj_4/7.png'
import img8 from './assert/proj_4/8.png'
import img9 from './assert/proj_4/9.png'
import img10 from './assert/proj_4/10.png'
const Gzxp24004 = () => {
  return (
  <div className="container">
    ...
    <h2>Hardware Setup:</h2>
        ...
        <h3>Connection setup:</h3>
                <img src={ConnectDiagram} className="img-fluid" alt="Connection_diagram"  title="Connection_diagram" style={{maxHeight: "400px"}}/>
    <h2>Software Setup:</h2>
        <h3>Set Up Sinric Pro Account:</h3>
            <p>Go to the Sinric Pro website and create an account.</p>
            <div>
                <img src={img1} className="img-fluid" alt="Login/create a sinric pro"  title="Automation"/>
            ...
            <div>
                <img src={img2} className="img-fluid col-12 col-sm-12 col-lg-8 col-xl-8" alt="Dashboard"  title="Automation"/>

            </div>
        <h3>Example for Add a new device:</h3>
            <div>
                <img src={img3} className="img-fluid  col-12 col-sm-12 col-lg-5 col-md-12 col-xl-5 me-2" alt="setup"  title="Automation"/>
                <img src={img4} className="img-fluid  col-12 col-sm-12 col-lg-5 col-md-12 col-xl-5" alt="setup"  title="Automation"/>
                <img src={img5} className="img-fluid  col-12 col-sm-12 col-lg-5 col-md-12 col-xl-5 me-2" alt="setup"  title="Automation"/>
                <img src={img6} className="img-fluid  col-12 col-sm-12 col-lg-5 col-md-12 col-xl-5 " alt="setup"  title="Automation"/>
            </div>
            ...
            <div className="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
                <div className="col">
                    ...
                    <img src={img8} className="img-fluid rounded col-12" alt="template"  title="Automation"/>
                </div>
                <div className="col">
                    <p><b>Add the relevant capabilities to each device.</b></p>
                    <img src={img9} className="img-fluid rounded col-12" alt="template"  title="Automation"/>
                </div>
            </div>
            <p>The Sinric Pro setup is now complete</p>
            <img src={img10} className="img-fluid rounded col-12 col-sm-12 col-lg-8 col-xl-8 me-2" alt="setup completed"  title="Automation"/>
        <h3>Arduino IDE:</h3>
            <ul>
