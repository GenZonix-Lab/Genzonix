        ...
        <div className='row justify-content-center'>
          <div className='col-md-8'>
            ...
            <div className='d-flex justify-content-between align-items-center mb-4'>
              ...
              <div className='text-center' style={{ color: '#2fdcffff' }}>
                <h2 className='p-0 m-0'>{currentYear}</h2>
                <p className='p-0 m-0'>{months[currentMonth]}</p>
              </div>
              <button 
                className='btn btn-default'
                onClick={() => {
            ...
            <div className='bg-white rounded shadow'>
              {/* Day Headers */}
              <div className='d-grid' style={{ gridTemplateColumns: 'repeat(7, 1fr)',color: '#230d9eff' }}>
                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                  <div key={day} className='p-md-3 text-center fw-bold bg-secondary text-white'>
                    {day}
                  </div>
                ))}
                {renderCalendar()}
